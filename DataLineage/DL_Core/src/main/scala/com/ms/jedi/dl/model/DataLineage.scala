...
import com.ms.jedi.dl.model.expr.{Expression, TypedExpression}
import com.ms.jedi.dl.model.op.{ExpressionAware, Operation}
...
(
  ...
  /**
    * A node representing the last operation performed within data lineage graph. Usually, it describes persistence of data set to some file, lake , database, Kafka endpoint, etc.
    */
  @Persist
