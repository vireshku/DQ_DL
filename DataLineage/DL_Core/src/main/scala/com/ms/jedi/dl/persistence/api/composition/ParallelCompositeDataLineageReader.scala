...
import com.ms.jedi.dl.model.PersistedDatasetDescriptor
import com.ms.jedi.dl.persistence.api.DataLineageReader.PageRequest

/**
  * The class represents a parallel composite reader from various persistence layers for the [[com.ms.jedi.dl.model.DataLineage DataLineage]] entity.
  *
