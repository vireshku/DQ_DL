...
import com.ms.jedi.dl.common.UUIDExtractors.UUIDExtractor
import com.ms.jedi.dl.model.DataLineageId
...
import com.ms.jedi.dl.persistence.impl.MongoImplicits._
...
import com.ms.jedi.dl.persistence.dao.BaselineLineageDAO.NON_WORD_CHAR
import com.ms.jedi.dl.persistence.impl.{DBCursorToCloseableIterableAdapter}
...
abstract class BaselineLineageDAO extends VersionedLineageDAO with Logging {
  ...
  import com.ms.jedi.dl.persistence.dao.BaselineLineageDAO.DBOFields._
